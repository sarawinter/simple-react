...
const SimpleBox = ({text, style}) => {

  const cssStyle = styles$1[style];

  return (
    React.createElement('div', { className: `${styles$1.box} ${cssStyle}`, __self: undefined, __source: {fileName: _jsxFileName$1, lineNumber: 10}}
      , text
    )
  );
};
...
exports.SimpleButtonStyleEnum = void 0; (function (SimpleButtonStyleEnum) {
  const primary = "primary"; SimpleButtonStyleEnum["primary"] = primary;
  const secondary = "secondary"; SimpleButtonStyleEnum["secondary"] = secondary;
})(exports.SimpleButtonStyleEnum || (exports.SimpleButtonStyleEnum = {}));

const _jsxFileName = "C:\\Repos\\npmPackages\\simple-react\\src\\components\\button\\SimpleButton.tsx";
const SimpleButton = ({ ...model }) => {
  const cssStyle = styles[model.style || exports.SimpleButtonStyleEnum.primary];

  return (
    React.createElement('button', {
      onClick: model.onClickEvent,
      className: `${styles.button} ${cssStyle}`,
      title: model.title, __self: undefined, __source: {fileName: _jsxFileName, lineNumber: 9}}
...
exports.SimpleBoxStyleEnum = void 0; (function (SimpleBoxStyleEnum) {
    const one = "one"; SimpleBoxStyleEnum["one"] = one;
    const two = "two"; SimpleBoxStyleEnum["two"] = two;
    const three = "three"; SimpleBoxStyleEnum["three"] = three;
  })(exports.SimpleBoxStyleEnum || (exports.SimpleBoxStyleEnum = {}));
